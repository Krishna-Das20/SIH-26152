                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 pt-2.5 border-t border-white/[0.06] text-[10px]">
                    ...
                    <div className="flex items-center gap-3 text-neutral-400 font-mono">
                      <span className="flex items-center gap-1 hover:text-white transition-colors">
                        <Heart className="w-3 h-3 text-rose-500/80" /> {post.likes}
                      </span>
                      <span className="flex items-center gap-1 hover:text-white transition-colors">
                        <Share2 className="w-3 h-3 text-neutral-400" /> {post.shares}
                      </span>
                      <span className="flex items-center gap-1 hover:text-white transition-colors">
                        <MessageCircle className="w-3 h-3 text-neutral-400" /> {post.replies}
                      </span>
                    </div>
                  </div>
                </div>
